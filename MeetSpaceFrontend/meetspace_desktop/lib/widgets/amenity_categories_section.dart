...
class AmenityCategoriesSection extends StatelessWidget {
  ...
  final Function(AmenityCategory) onEdit;
  final Function(AmenityCategory) onDelete;
  ...
  const AmenityCategoriesSection({
    super.key,
