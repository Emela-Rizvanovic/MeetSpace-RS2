    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.UserId, x.SpaceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendationLogs_Spaces_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Spaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpaceBlockedDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpaceBlockedDates_Spaces_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Spaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpaceWorkingHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpaceWorkingHours_Spaces_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Spaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecommendationLogs_SpaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpaceBlockedDates_SpaceId",
                table: "SpaceBlockedDates",
                column: "SpaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpaceWorkingHours_SpaceId",
                table: "SpaceWorkingHours",
                column: "SpaceId");
